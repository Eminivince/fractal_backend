...
export async function platformRoutes(app: FastifyInstance) {
  ...
  // I-51: Public platform regulatory status disclosure
  app.get(
    "/v1/platform/regulatory-status",
    async (_request: FastifyRequest) => {
      return {
        platformName: "Fractal",
        country: "Nigeria",
        regulatoryStatus: "operating_under_exemption",
        registrationDetails: {
          secNigeriaStatus: "Pending registration as a Securities Exchange under the Investments and Securities Act (ISA) 2007",
          cbnStatus: "Not a licensed bank or payment institution. Payment processing facilitated through licensed payment service providers.",
          fccpcStatus: "Compliance with the Federal Competition and Consumer Protection Act (FCCPA) 2018",
        },
        operatingFramework: "Fractal operates as a technology platform that facilitates the issuance and management of real-world asset (RWA) tokenization programs. Offerings listed on Fractal are private placements made by third-party issuers, not by Fractal itself.",
        investorProtections: [
          "KYC verification required for all investors before subscription",
          "Mandatory cooling-off period for subscriptions",
          "All offering terms reviewed by Fractal's compliance team before approval",
          "Escrowed funds held separately from platform operating accounts",
          "Withholding tax deducted and remitted to FIRS on applicable distributions",
        ],
        disclaimers: [
          "Fractal does not provide investment advice. All investment decisions are your own.",
          "Past performance of offerings on this platform does not guarantee future results.",
          "Real-world asset investments carry illiquidity, market, and regulatory risks.",
          "Fractal is not a financial institution and does not guarantee the performance of any issuer or offering.",
        ],
        contactEmail: "compliance@fractal.finance",
