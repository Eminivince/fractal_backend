...
/** A provider outcome before our durable dispatch record is an exception, never proof of settlement. */
export const professionalPayoutUnexpectedProviderOutcomeMigration: PostgresMigration = {
  version: "042-professional-payout-unexpected-provider-outcome",
  sql: `
